...
public class Presenter {
    ...
    private static final String TAG = "sdses_Presenter";
    ...
    public void onCreate(AppCompatActivity appCompatActivity) {
        if (mqttService == null){
            android.util.Log.d(TAG, "Presenter对象调用 onCreate: mqttService为null");
            return;
        }
        android.util.Log.d(TAG, "Presenter对象调用 onCreate()  mqttService已启动");
